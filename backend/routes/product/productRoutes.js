...
const { getAllProducts, getProductById, getProductDetail, fetchRelatedProducts, searchProducts, searchAndFetchRelatedProducts, getProductsByCategory, getProductsByGender, getProductFilters } = require("../../controllers/product/productController");

...
const Products = () => {
  ...
  const ProductGrid = useMemo(() => React.memo(({ products, hoveredProductId, selectedVariant, handleProductMouseEnter, handleProductMouseLeave, handleVariantChange, getLowestPrice, getSelectedVariant, getAvailableSizes }) => (
        ...
        return (
          ...
          >
            ...
            <div className="relative cursor-pointer group">
                    ...
                    <div className="flex flex-wrap justify-center gap-2">
                      {product.variants.map((variant) => (
                        <button
                          ...
                          className={`w-6 h-6 rounded-full border ${selectedVariant[product._id] === variant._id
              ...
              <div
                className={`absolute bottom-0 left-0 right-0 bg-white p-2 transition-opacity duration-300 ${hoveredProductId === product._id
                    ? "opacity-100"
                    : "opacity-0"
                  }`}
              >
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await axiosInstance.get(`/products/get?${queryParams.toString()}`);
  ...
  const getSelectedVariant = useMemo(() => (product) => {
